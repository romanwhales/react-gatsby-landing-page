...
import mockUp1 from "../../images/animations/mockup1.svg";
import mockUp2 from "../../images/animations/mockup2.svg";
import mockUp3 from "../../images/animations/mockup3.svg";
import mockUp4 from "../../images/animations/mockup4.svg";
import mockUp5 from "../../images/animations/mockup5.svg";
...
const Wrapper = styled.div`
  ...
  * {
  ...
  .mockup1 {
    ...
    background-filter: blur(21.8507px);
    border-radius: 16px;
  }
  .mockup2 {
    position: absolute;
  ...
  .mockup5 {
    ...
    left: 616px;
    top: 262px;
    background: url(${mockUp5}), rgba(39, 20, 62, 0.3);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px);
    /* Note: backdrop-filter has minimal browser support */
    border-radius: 8px;
